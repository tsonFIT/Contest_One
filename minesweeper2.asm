...
flags BYTE gridSizeSquare DUP(0)
msgIntroPrompt BYTE "Welcome to Minesweeper! Press any key to start.",0
msgRevealPrompt BYTE "Reveal a cell (row column): ",0
msgFlagPrompt BYTE "Flag a cell (row column): ",0
msgInvalidPrompt BYTE "Invalid input. Please try again.",0
...
displayColLoop:
    ...
    cmp flags[eax], 1 ; Check if cell is flagged
    je displayFlag
